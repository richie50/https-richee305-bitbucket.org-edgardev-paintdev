...
public class PaintAppFrame extends JFrame implements MouseListener,
	...
	final int[] MNEMONICS = { KeyEvent.VK_B, KeyEvent.VK_S, KeyEvent.VK_W, KeyEvent.VK_N,
			KeyEvent.VK_T, KeyEvent.VK_H, KeyEvent.VK_U, KeyEvent.VK_D, KeyEvent.VK_L,
			KeyEvent.VK_R };
	...
	protected boolean fileExistenceChecker(File file){
		...
		return JOptionPane.showOptionDialog(this, "The file '" + file.getName() + "' already exists.  "
